...
After a global install two commands exist and do the same thing — `ttfx`
(matches the upstream docs) and `ttfx-js` (matches the package name):
...
# ...or replace ttfx with ttfx-js in any of the above
```
